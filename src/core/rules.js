...
export const RULES = Object.freeze({
  ...
  PLAYER_SHOTS_MAX: 1,
  // cannon + player shot + 3 invader shots = five moving objects. The UFO
  // shares the squiggly shot's slot: the two are never on screen together.
  INVADER_SHOT_SLOTS: 3,
  UFO_SHARES_SLOT_WITH: 'squiggly',
  // The plunger shot is disabled entirely while exactly this many aliens remain.
  PLUNGER_DISABLED_AT_ALIENS: 1,
  ...
  // Waves 1..9 start progressively lower; wave 10 reverts to wave 1's height.
  WAVE_HEIGHT_CYCLE: 9,
